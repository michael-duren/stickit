...
function Nav() {
  ...
  */
  ...
  return (
    <AppBar
      className="background-primary-blue"
      position="static"
      sx={{ backgroundColor: '#005e83', boxShadow: 'none' }}
    >
      <Container
        className="background-primary-blue"
        maxWidth="xl"
      ...
      >
        <Toolbar className="display-flex nav-spacing">
          ...
          >
            <Link className="nav-title" to={user.id ? '/home' : '/login'}>
          ...
          >
            ...
            >
              <div
                ...
                className="display-flex m-t-l m-b-xl"
              >
                <img
                  className="logo-img-black full-nav-logo"
                  style={{ fill: 'white' }}
                  src={logoImg}
                  alt=""
                />
